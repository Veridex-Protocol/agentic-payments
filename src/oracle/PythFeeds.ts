...
export const CHAIN_NATIVE_FEED_MAP: Record<string, string> = {
    ...
    // Usually ETH.
    'stacks': PYTH_FEED_IDS.STX, // Stacks uses STX for gas.
    'Stacks': PYTH_FEED_IDS.STX,
    'Stacks Testnet': PYTH_FEED_IDS.STX,
    'avalanche': PYTH_FEED_IDS.AVAX, // Avalanche uses AVAX for gas.
    'Avalanche': PYTH_FEED_IDS.AVAX,
    'Avalanche Fuji': PYTH_FEED_IDS.AVAX,
};

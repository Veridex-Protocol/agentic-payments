            ...
            const presets: Record<string, any> = {
                ...
                'stacks': {
                    ...
                    testnet: {
                        ...
                        name: 'Stacks Testnet',
                        contracts: {
                            hub: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.veridex-spoke',
                            wormholeCoreBridge: '',
                        },
                    },
                    mainnet: {
...
vi.mock('@veridex/sdk/chains/stacks', () => ({
    StacksClient: vi.fn().mockImplementation(() => ({
        getConfig: () => ({ name: 'Stacks Testnet', chainId: 2147483648, wormholeChainId: 60, isEvm: false }),
        ...
        getVaultStxBalance: vi.fn().mockResolvedValue(0n),
        getVaultSbtcBalance: vi.fn().mockResolvedValue(0n),
        ...
        checkSessionActive: vi.fn().mockResolvedValue(false),
        getRemainingBudget: vi.fn().mockResolvedValue(0n),
    })),
    StacksClientConfig: {},
}));
...
describe('ChainClientFactory', () => {
    describe('createClient', () => {
        ...
        it('should create Stacks client', () => {
            const client = ChainClientFactory.createClient('stacks' as any, 'testnet');
            expect(client).toBeDefined();
        });
